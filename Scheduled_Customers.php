...
<head>
  ...
  <title>Scheduled Customers</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="container">
                  <button class="btn btn-primary my-2"><a href="addingscheduled.php" class="text-light"> Add </a></button>
        ...
        <th scope="row">' . $services . '</th>
           ...
           <td>
           <a href="updatescheduled.php? updatesched=' . $id . '" ><i class="fa fa-pencil"></i></a>
           <a href="view_scheduled.php? viewbooked=' . $id . '"><i class="fa fa-search" style="color:gray"></i></a>
           <a href="delete_scheduled.php? deletesched=' . $id . '"><i class="fa fa-trash" style="color:gray"></i></a>
