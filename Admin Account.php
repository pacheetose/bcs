          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Admin Account</a></li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="container">
                  <Br>
                  <button class="btn btn-primary my-2"><a href="CreateAccount.php" class="text-light"> Create </a></button>
         ...
         <th scope="row">' . $Name . '</th>
           ...
           <td>
           <a href="UpdateAdmin.php? updatesadmin=' . $id . '" ><i class="fa fa-pencil"></i></a>
           <a href="view_accounts.php? updateadmin=' . $id . '"><i class="fa fa-search" style="color:gray"></i></a>
           <a href="delete_admin.php? deleteaccount=' . $id . '"><i class="fa fa-trash" style="color:gray"></i></a>
           </td>
