          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Inquiry</a></li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="container">
                  <button class="btn btn-primary my-2"><a href="addinquiry.php" class="text-light"> Add </a></button>
         ...
         <th scope="row">' . $id . '</th>
           ...
           <td>
           <a href="updateInquiry.php? updateidinq=' . $id . '" ><i class="fa fa-pencil"></i></a>
           <a href="view_inquiry.php? updateid4=' . $id . '"><i class="fa fa-search" style="color:gray"></i></a>
           <a href="delete_pending.php? deleteid=' . $id . '"><i class="fa fa-trash" style="color:gray"></i></a>
