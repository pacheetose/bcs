...
if (isset($_POST['submit'])) {
  ...
  $sql = "insert into admin (Name, email, Contact, Password) 
                  ...
                  <form method="post">
                    ...
                    <div class="form-row">
                      <div class="col">
                        ...
                        <input type="tel" class="form-control" name="Contact" placeholder="Contact" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="col">
                        <label> Enter Password</label>
                        <input type="text" class="form-control" name="Password" placeholder="password" autocomplete="off" required><br>
                      </div>
                    </div>
