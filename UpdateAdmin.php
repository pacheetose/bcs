                  ...
                  <form method="post">
                    ...
                    <div class="form-row">
                      <div class="col">
                        ...
                        <input type="text" class="form-control" name="Contact" autocomplete="off" value=<?php echo $Contact; ?>>
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="col">
                        ...
                        <input type="text" class="form-control" name="Password" autocomplete="off" value=<?php echo $Password; ?>><br>
                      </div>
                    </div>
